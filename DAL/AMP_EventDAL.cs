        ...
        public static EventInfo getEventInfo(int nEventId)
        {
            ...
            if (!string.IsNullOrEmpty(nEventId.ToString()))
            {
                ...
                try
                {
                    ...
                    strSQL += " FROM  (((EV200_EVENT_MASTER EV200_EVENT_MASTER LEFT OUTER JOIN " + strCompDatabase + ".dbo.EV870_ACCT_MASTER EV870_ACCT_MASTER_SLSP ON EV200_EVENT_MASTER.EV200_SNAPSHOT_ID=@nsnapshotcurrentid and (EV200_EVENT_MASTER.EV200_ORG_CODE=EV870_ACCT_MASTER_SLSP.EV870_ORG_CODE) AND (EV200_EVENT_MASTER.EV200_SLSPER=EV870_ACCT_MASTER_SLSP.EV870_ACCT_CODE)) ";
                    ...
                    strSQL += " WHERE EV200_EVT_ID=@eventid";
